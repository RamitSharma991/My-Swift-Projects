...
//  OmgMarbles
//
//  Created by Ramit sharma on 25/02/19.
...
class GameScene: SKScene {
    var balls = ["ballBlue","ballGreen","ballPurple","ballRed","ballYellow","ball","","","",""]
...
//
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if matchedBalls.count >= 5 {
            ...
            let appear = SKAction.group([SKAction.scale(by: 1, duration: 0.25), SKAction.fadeIn(withDuration: 0.25)])
